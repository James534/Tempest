...
ifeq ($(config),release64)
  ...
  DEFINES   += -DGLEW_STATIC -DGLEW_DYNAMIC_LOAD_ALL_GLX_FUNCTIONS=1 -DGWEN_COMPILE_STATIC -DDONT_USE_GLUT
  INCLUDES  += -I../../examples/ThirdPartyLibs/Glew -I../../examples/ThirdPartyLibs/Gwen -I../../examples/ThirdPartyLibs
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  CFLAGS    += $(CPPFLAGS) $(ARCH) -O2 -msse2 -ffast-math -m64
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -s -m64 -L/usr/lib64
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += -lGL -ldl -lX11 -lpthread
  LDDEPS    += 
...
ifeq ($(config),debug64)
  ...
  DEFINES   += -D_DEBUG=1 -DGLEW_STATIC -DGLEW_DYNAMIC_LOAD_ALL_GLX_FUNCTIONS=1 -DGWEN_COMPILE_STATIC -DDONT_USE_GLUT
  INCLUDES  += -I../../examples/ThirdPartyLibs/Glew -I../../examples/ThirdPartyLibs/Gwen -I../../examples/ThirdPartyLibs
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
